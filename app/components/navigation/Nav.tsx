      ...
      <div className="sm:w-[90%] w-[95%] mx-auto flex h-[100%] items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <button className="px-6 py-2 sm:px-8 sm:py-3 text-[14px] sm:text-[16px] bg-blue-950 transition-all duration-200 hover:bg-red-600 flex items-center rounded-md space-x-2 text-white ">
            <span>
              <BiCycling className="w-[1.3rem] h-[1.3rem] sm:w-[1.7rem] sm:h-[1.7 rem]" />
            </span>
            <span className="font-bold">Order Now</span>
          </button>
          <button className="sm:px-6 sm:py-3 px-4 hover:bg-green-700 transitiona-all duration-200 bg-orange-600 flex items-center text-white">
            <BiShoppingBag className="w-[1.3rem] h-[1.3rem] sm:w-[1.7rem] sm:h-[1.7 rem]" />
          </button>
